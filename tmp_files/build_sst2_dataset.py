...
def main(cfg: DictConfig):
    ...
    path = '/home/local/anaconda3/envs/paper/DPR/building_dataset/sst2/'
    ...
    for query_number in [10]:
        ...
        for random_seed in [1234,5678,1004,9999,7777]:
            ...
            for subspace_size in [50, 100]:
                ...
                total_queries = pd.DataFrame(query_result.reshape(2*query_number,2), columns=['text','label'])

                for LABEL_sst2 in np.unique(total_queries['label']):
                    
                    questions = list(total_queries[total_queries['label'] == LABEL_sst2]['text'])
