...
def main(cfg: DictConfig):
    output_path = 'output/simcse_output.json'
    batch_size = 1024
    ...
    if cfg.rpc_retriever_cfg_file:
        print('retriever DenseRPCRetriever')
    ...
    # get top k results
    print('\n')
    print('get top k passages start!!!!!!')
    ...
    if cfg.kilt_out_file:
        ...
        kilt_ctx.convert_to_kilt(qa_src.kilt_gold_file, output_path, cfg.kilt_out_file)
