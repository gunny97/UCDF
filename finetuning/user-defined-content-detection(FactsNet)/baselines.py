...
# https://github.com/pholur/situation-modeling/blob/main/primitive_baselines.py
...
def draw_roc_curve(prob, dataset,content_name):
    ...
    plt.legend(loc=4)
    plt.show()
    plt.savefig(f'/home/local/anaconda3/envs/paper/DPR/finetuning/facts_net/baseline_roc_curve_png/ROC_{content_name}.png')
...
if __name__ == "__main__":
    ...
    # test_: UCDF --> finetuning.py에서 test까지 다 처리 됨
