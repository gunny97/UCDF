...
def draw_roc_curve(prob, dataset,content_name):
    ...
    plt.legend(loc=4)
    plt.show()
    plt.savefig(f'/home/local/anaconda3/envs/paper/DPR/finetuning/facts_net/roc_curve_png/ROC_{content_name}.png')
...
def main(pos_train_path, neg_train_path, query_list, content_name, test_data_path ,TRAIN_MODE = True):
    ...
    if TRAIN_MODE:
        ...
        for epoch in range(num_epochs):
            ...
            if avg_vloss < best_vloss:
                ...
                model.save_pretrained(f"/home/local/anaconda3/envs/paper/DPR/finetuning/facts_net/error_6_ckpt/{content_name}")
        ...
        # validation
        model = AutoModelForSequenceClassification.from_pretrained(f"/home/local/anaconda3/envs/paper/DPR/finetuning/facts_net/error_6_ckpt/{content_name}", num_labels=2)
        model.to(device)
        pred = []
        ref = []
    ...
    pred, logit, f1_score, acc_score, rec_score, prec_score = evaluate_result(ckpt=f'/home/local/anaconda3/envs/paper/DPR/finetuning/facts_net/error_6_ckpt/{content_name}', dataset=Test_data, existed=False)
...
if __name__ == "__main__":
    ...
    # fileHandler = logging.FileHandler('./factsNet_finetuned_UCDF_results.log')
    fileHandler = logging.FileHandler('./ss_500_factsnet_UCDF.log')
    ...
    test_data_path = "/home/local/anaconda3/envs/crawl/crawler/test_data"
    test_data_path_list = []
    ...
    path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet" 
    file_list = []
    ...
    for i,x in enumerate(file_list[0::2]):
        ...
        # Only Evaluation
        # ckpt_exist = os.path.exists(f"/home/local/anaconda3/envs/paper/DPR/finetuning/facts_net/ckpt/{content_name}")
        ...
        # Only Training
        ckpt_exist = os.path.exists(f"/home/local/anaconda3/envs/paper/DPR/finetuning/facts_net/error_6_ckpt/{content_name}")
        if ckpt_exist:
            ...
            if pos_train_path == "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet/history/query_culture-facts.csv_positive.csv":
                test_data_path = "/home/local/anaconda3/envs/crawl/crawler/test_data/history/culture-facts.csv"
                pos_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_culture-facts_positive.csv"
                neg_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_culture-facts_negative.csv"
                query_list_path = "/home/local/anaconda3/envs/crawl/crawler/query_output/history/culture/query_culture-facts.csv"

            elif pos_train_path == "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet/nature/query_cat-facts.csv_positive.csv":
                test_data_path ="/home/local/anaconda3/envs/crawl/crawler/test_data/nature/cat-facts.csv"
                pos_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_cat-facts_positive.csv"
                neg_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_cat-facts_negative.csv"
                query_list_path = "/home/local/anaconda3/envs/crawl/crawler/query_output/nature/animals/query_cat-facts.csv"

            elif pos_train_path == "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet/nature/query_otter-facts.csv_positive.csv":
                test_data_path ="/home/local/anaconda3/envs/crawl/crawler/test_data/nature/otter-facts.csv"
                pos_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_otter-facts_positive.csv"
                neg_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_otter-facts_negative.csv"
                query_list_path = "/home/local/anaconda3/envs/crawl/crawler/query_output/nature/animals/query_otter-facts.csv"

            elif pos_train_path == "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet/nature/query_bear-facts.csv_positive.csv":
                test_data_path = "/home/local/anaconda3/envs/crawl/crawler/test_data/nature/bear-facts.csv"
                pos_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_bear-facts_positive.csv"
                neg_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_bear-facts_negative.csv"
                query_list_path = "/home/local/anaconda3/envs/crawl/crawler/query_output/nature/animals/query_bear-facts.csv"

            elif pos_train_path == "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet/nature/query_whale-facts.csv_positive.csv":
                test_data_path = "/home/local/anaconda3/envs/crawl/crawler/test_data/nature/whale-facts.csv"
                pos_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_whale-facts_positive.csv"
                neg_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_whale-facts_negative.csv"
                query_list_path = "/home/local/anaconda3/envs/crawl/crawler/query_output/nature/animals/query_whale-facts.csv"
                
            elif pos_train_path == "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet/world/query_egypt-facts.csv_positive.csv":
                test_data_path = "/home/local/anaconda3/envs/crawl/crawler/test_data/world/egypt-facts.csv"
                pos_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_egypt-facts_positive.csv"
                neg_train_path = "/home/local/anaconda3/envs/paper/DPR/building_dataset/factsnet_error_update/error_updatequery_egypt-facts_negative.csv"
                query_list_path = "/home/local/anaconda3/envs/crawl/crawler/query_output/world/countries/query_egypt-facts.csv"
            else:
                continue
